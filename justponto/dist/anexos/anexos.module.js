...
exports.AnexosModule = void 0;
const common_1 = require("@nestjs/common");
const anexos_service_1 = require("./anexos.service");
const anexos_controller_1 = require("./anexos.controller");
const data_module_1 = require("../data/data.module");
let AnexosModule = class AnexosModule {
};
exports.AnexosModule = AnexosModule;
exports.AnexosModule = AnexosModule = __decorate([
    (0, common_1.Module)({
