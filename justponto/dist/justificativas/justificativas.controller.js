...
const anexos_service_1 = require("../anexos/anexos.service");
...
let JustificativasController = class JustificativasController {
    ...
    async criar(dto, usuario, arquivo) {
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(perfil_usuario_enum_1.PerfilUsuario.GERENTE, perfil_usuario_enum_1.PerfilUsuario.RH, perfil_usuario_enum_1.PerfilUsuario.DIRECAO),
    (0, swagger_1.ApiOperation)({ summary: 'Lista todas as justificativas com filtros (Gerente/RH/Direção)' }),
...
exports.JustificativasController = JustificativasController = __decorate([
    ...
    __metadata("design:paramtypes", [justificativas_service_1.JustificativasService,
        anexos_service_1.AnexosService])
